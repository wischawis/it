    ...
    <script>
        $(document).ready( function () {
            ...
            $('#cancel').click(function () {
                window.location = "../controller/editSubject.php";
                return false;
            });
        });
    </script>
...
<body>
<center><h2>แก้ไขข้อมูลรายวิชา</h2></center>
<br/>
<br/>
<form action="../model/manageSubject.php" method="post">
    <input type="hidden" name="idsub" id="idsub"  value="<?=$data[0]['id_subject']?>"/>
    <div class="row">
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">ชื่อรายวิชา</label>
            <div class="col-md-8 col-sm-8 col-xs-12">
                <input type="text" class="form-control" name="name_th" id="name_th" value="<?=$data[0]['name_th']?>"/>
            </div>
        </div>
    </div>
    <br/>
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
                <input type="text" class="form-control" name="subject_code" maxlength="8" minlength="8" id="subject_code" value="<?=$data[0]['subject_code']?>"/>
            </div>
        </div>
    </div>
    <br/>
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
                <textarea  type="text" class="form-control" rows="10" name="description" id="description" minlength="20" ><?=$data[0]['description']?></textarea>
            </div>
        </div>
    </div>
    <br/>
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
                <input type="submit" class="btn btn-default" name="edit" id="edit" value="บันทึก"/>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12"></div>
        </div>
    </div>
