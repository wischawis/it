                ...
                <form id ="register" method="post" name="register" action="model/register.php">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="email" id="email" maxlength="40"/><br/></td>
                        </tr>
                            <td></td>
                            <td style="text-align: left"><label id="pic_chk" style="display: none; color: red;">ได้โปรดเลือกรูปด้วยเถอะนะ</label><br/></td>
                        </tr>
                        <tr>
